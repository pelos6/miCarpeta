...
-- Volcando estructura para tabla serviciosmicarpetaconcursosprimaria.ctpri_bar
CREATE TABLE IF NOT EXISTS `ctpri_bar` (
...
-- Volcando datos para la tabla serviciosmicarpetaconcursosprimaria.ctpri_bar: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `ctpri_bar` DISABLE KEYS */;
INSERT INTO `ctpri_bar` (`COD_CON`, `COD_SOL`, `DNI`, `RES_TOT`, `APA_1`, `APA_1_1`, `APA_1_1_1`, `APA_1_1_2`, `APA_1_1_3`, `APA_1_2`, `APA_1_2_1`, `APA_1_2_2`, `APA_1_2_3`, `APA_2`, `APA_3`, `APA_3_1`, `APA_3_1_1`, `APA_3_1_2`, `APA_3_1_3`, `APA_3_1_4`, `APA_3_2`, `APA_3_2_1`, `APA_3_2_2`, `APA_3_2_3`, `APA_3_2_4`, `APA_3_3`, `APA_4`, `APA_4_1`, `APA_4_2`, `APA_4_3`, `APA_5`, `APA_5_1`, `APA_5_2`, `APA_5_3`, `APA_6`, `APA_6_1`, `APA_6_2`, `APA_6_3`, `APA_6_4`, `APA_6_5`, `APA_6_6`) VALUES
	('50', '0103', '00000001R', '37.3332', '27.3332', '17.0000', '15.0000', '2.0000', '0.0000', '10.3332', '10.3332', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '4.0000', '0.0000', '0.0000', '4.0000', '6.0000', '6.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '0.0000');
/*!40000 ALTER TABLE `ctpri_bar` ENABLE KEYS */;
...
INSERT INTO `ctpri_sol` (`DNI`, `COD_CON`, `COD_SOL`, `F_HOR_ENT`, `COD_EST_SOL`, `COD_MOD_PAR`) VALUES
	('00000001R', '50', '0101', '2015-08-04 18:00:00', '0', 'A'),
	('00000001R', '50', '0102', '2015-07-30 22:59:00', '0', 'A'),
	('00000001R', '50', '0103', '2015-07-30 01:02:00', '0', 'A'),
	('00000002W', '50', '1203', '2015-08-03 02:03:00', '0', 'K');
...
, c.l_act, f.des_fas_con ,'http://servicios.aragon.es/tpri/' AS `url`, 
 DATE_FORMAT(f_ini_sol,'%d/%c/%Y') f_ini_sol, 
 DATE_FORMAT(f_fin_sol,'%d/%c/%Y') f_fin_sol
  from ctpri_con c , ctpri_fas_con f
...
ctpri_est_sol e, ctpri_mod_par p
WHERE s.cod_con = o.cod_con AND s.cod_est_sol = e.cod_est_sol 
and f.cod_fas_con = o.cod_fas_con and 
p.COD_MOD_PAR = s.COD_MOD_PAR ;


-- Volcando estructura para vista serviciosmicarpetaconcursosprimaria.vsolicitudesbaremadas
-- Eliminando tabla temporal y crear estructura final de VIEW
