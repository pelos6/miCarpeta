 ...
 <?php
        foreach ($vacantesActo as $vacanteActo) {
           // echo $vacanteActo->num_vac .' '.$vacanteActo->lat.' '.$vacanteActo->lon . "<br />\n" ;
            echo '<input type="hidden" name="cue_esp" value="'.$vacanteActo->cod_cue.' '.$vacanteActo->cod_esp. '">';
...
<div class="alert alert-success">
    <?php
        foreach ($especialidadesActo as $especialidadActo) {
          // echo '<a href="#googleMap" onclick="mostrarActoEleccionMapa('."'0590 001'".');" >' . $especialidadActo->cod_cue .' '.$especialidadActo->cod_esp . "</a><br />\n";
          echo Html::button(' '.$especialidadActo->cod_cue .' '.$especialidadActo->cod_esp .' ', [ 'class' => 'btn btn-primary', 'onclick' => 'mostrarActoEleccionMapa("'.$especialidadActo->cod_cue .' '.$especialidadActo->cod_esp .'");' ]);
