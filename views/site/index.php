...
$this->title = 'Mi Carpeta';
//$client=new SoapClient('http://localhost/CicloFormativoGradoSuperior/practicas_propias/php/restdeerawan/yii2-advanced-api/api/web/v1/countries?wsdl'); 
//echo $client->getPrice('ES');
?>
