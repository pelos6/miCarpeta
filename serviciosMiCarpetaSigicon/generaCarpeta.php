...
//        $uri="especifica la ubiación de los ficheros dominio de nombres"
        $url="http://localhost/CicloFormativoGradoSuperior/practicas_propias/php/miCarpeta/serviciosMiCarpetaSigicon/ServerSigicon.php";
        $uri="http://localhost/CicloFormativoGradoSuperior/practicas_propias/php/miCarpeta/serviciosMiCarpetaSigicon/";
        
 
 echo 'hola';
         //serviciow.php es el fichero que genera el objeto servidor soap 
        $accion = new WSDLDocument("ServerSigicon",$url,$uri);
